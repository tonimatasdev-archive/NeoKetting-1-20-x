...
public class Main {
    ...
    public static void agentmain(String agentArgs, Instrumentation inst) throws Exception {
        ...
        inst.appendToSystemClassLoaderSearch(new JarFile(new File(urlKettingCommon.toURI())));
    ...
    public static Object[] agent_pre_kettingcommon() throws Exception{
        ...
        File kettingcommon = new File(LauncherDir, "libraries/org/kettingpowered/common/bundled/common-bundled.jar");
        JarUtils.extractJarContent("data/common-bundled.jar", kettingcommon);
        return new Object[]{dependencyList, kettingcommon.toURI().toURL()};
    }
